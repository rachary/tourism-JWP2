            ...
            <div class="form-container">
                <form @submit.prevent="submit">
                    ...
                    <div class="form-right">
                        ...
                        <div class="row">
                            <button @click="refDestinationImage.click()">
...
const onFileChange = async (event) => {
    ...
    let countImages = images.value.filter(image => image.url).length
...
const getFormData = () => {
    ...
    form.destination_images.forEach((image, index) => {
        formData.append(`destination_images[${index}]`, image)
    })
}
...
const submit = async () => {
    ...
    try {
        const response = await api.POST('/api/destination', form)
